...
>
  ...
  >
    <div class="mb-6">
      <h2 class="text-xl font-bold text-white mb-1 tracking-wide">Tambah Log Entry</h2>
      <p class="text-sm text-slate-400 mt-1">Versi akan naik tanpa memindah task</p>
    </div>
    ...
    <div class="flex items-center gap-3 mb-5 px-1">
      ...
      <div class="flex items-center gap-2">
        ...
        <span class="font-mono text-xs text-amber-400 bg-amber-500/10 px-2 py-1 rounded border border-amber-500/20">{nextVersion}</span>
      </div>
    </div>
    ...
    <div class="mb-6">
      <textarea
        ...
        class="w-full bg-white/[0.04] border border-white/[0.08] rounded-xl p-4 text-sm text-slate-200 resize-none min-h-[100px] focus:outline-none focus:border-amber-500/50 focus:ring-1 focus:ring-amber-500/50 transition-all placeholder:text-slate-500"
        required
      ></textarea>
      <div class="h-4 mt-1">
