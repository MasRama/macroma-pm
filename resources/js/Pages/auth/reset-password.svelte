...
<div class="min-h-screen bg-white dark:bg-[#020617] text-slate-900 dark:text-slate-100 flex overflow-hidden font-sans selection:bg-info-500/30">
  ...
  <div class="hidden lg:flex w-1/2 bg-slate-100 dark:bg-[#020617] relative overflow-hidden items-center justify-center border-r border-slate-200 dark:border-white/5 order-1">
      ...
      <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary-500/5 rounded-full blur-[150px] opacity-60 dark:opacity-100"></div>

      <div class="relative z-10 w-full max-w-lg p-12 flex flex-col items-center text-center">
          <!-- Glassmorphism Password Reset UI -->
          <div class="w-full max-w-xs mx-auto bg-white/90 dark:bg-white/5 backdrop-blur-2xl border border-slate-200 dark:border-white/10 rounded-3xl p-8 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] dark:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] transform -rotate-2 hover:rotate-0 transition-transform duration-700 ease-out mb-12 relative overflow-hidden">
             ...
             <div class="w-20 h-20 mx-auto rounded-2xl bg-info-50 dark:bg-info-500/20 flex items-center justify-center border border-info-100 dark:border-info-500/30 mb-8">
                 <svg class="w-10 h-10 text-info-500 dark:text-info-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
             ...
             <div class="flex items-center justify-center gap-2 mb-4">
                 ...
                 <div class="w-3 h-3 rounded-full bg-slate-300 dark:bg-slate-600"></div>
                 <div class="w-3 h-3 rounded-full bg-slate-300 dark:bg-slate-600"></div>
                 <div class="w-3 h-3 rounded-full bg-info-500 dark:bg-info-400 animate-pulse"></div>
             </div>
             <div class="h-2 w-32 mx-auto bg-slate-200 dark:bg-slate-400/50 rounded-full"></div>
          </div>

          <h2 class="text-5xl font-bold tracking-tighter text-slate-900 dark:text-white mb-4 leading-tight">
            RESTORE.<br/> 
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-info-500 via-primary-500 to-purple-500 dark:from-info-400 dark:via-primary-400 dark:to-purple-400">RECONNECT.</span>
          </h2>
  ...
  <div class="w-full lg:w-1/2 flex flex-col justify-between p-8 lg:p-12 z-10 relative order-2 overflow-y-auto">
      ...
      <div class="max-w-md w-full mx-auto my-8 lg:my-0" in:fly={{ y: 20, duration: 600 }}>
          <div class="bg-white/90 dark:bg-white/5 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-2xl p-8 shadow-2xl">
              <h1 class="text-3xl font-bold tracking-tight mb-2 text-slate-900 dark:text-white">Create New Password</h1>
              <p class="text-slate-500 dark:text-slate-400 mb-8 text-sm">Please choose a strong password for your account.</p>

              <!-- Reset Form -->
              <form class="space-y-4" onsubmit={(e) => { e.preventDefault(); submitForm(); }}>
                  <div class="space-y-1.5">
                      <label for="password" class="block text-sm font-medium text-slate-700 dark:text-slate-300 ml-1">New Password</label>
                  ...
                  <div class="space-y-1.5">
                      <label for="confirm-password" class="block text-sm font-medium text-slate-700 dark:text-slate-300 ml-1">Confirm Password</label>
                  ...
                  <p class="text-center text-sm text-slate-500 dark:text-slate-400 mt-6">
                      Remember your password? <a href="/login" use:inertia class="font-semibold text-info-500 dark:text-info-400 hover:text-info-600 dark:hover:text-info-300 transition-colors">Sign in</a>
                  </p>
              </form>
          </div>
      </div>
