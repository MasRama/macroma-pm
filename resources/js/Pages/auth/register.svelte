...
<div class="min-h-screen bg-[#020617] text-slate-100 flex overflow-hidden font-sans selection:bg-info-500/30">
  ...
  <div class="hidden lg:flex w-1/2 bg-[#020617] relative overflow-hidden items-center justify-center border-r border-white/5 order-1">
      ...
      <div class="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-primary-500/10 rounded-full blur-[120px] animate-pulse" style="animation-duration: 11s;"></div>
      <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-purple-500/5 rounded-full blur-[150px]"></div>

      <div class="relative z-10 w-full max-w-lg p-12 flex flex-col items-center text-center">
          <!-- Glassmorphism Terminal Mock UI -->
          <div class="w-full bg-white/5 backdrop-blur-2xl border border-white/10 rounded-2xl p-6 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] transform rotate-2 hover:rotate-0 transition-transform duration-700 ease-out mb-12 text-left font-mono text-sm">
              <div class="flex items-center justify-between mb-4 border-b border-white/5 pb-4">
                  ...
                  <div class="text-xs text-slate-500">setup.sh</div>
              </div>
              ...
              <div class="space-y-3 text-slate-300">
                  ...
                  <div class="flex gap-2 mt-2">
                      <span class="text-primary-400">✓</span>
                      <span class="text-white font-medium">Workspace ready in 0.8s</span>
                  </div>
              </div>
          </div>
          ...
          <h2 class="text-5xl font-bold tracking-tighter text-white mb-4 leading-tight">
            BUILD TEAMS.<br/> 
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-info-400 via-purple-400 to-primary-400">NOT BOTTLENECKS.</span>
          </h2>
  ...
  <div class="w-full lg:w-1/2 flex flex-col justify-between p-8 lg:p-12 z-10 relative order-2 overflow-y-auto">
      ...
      <div class="max-w-md w-full mx-auto my-8 lg:my-0" in:fly={{ y: 20, duration: 600 }}>
          <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
              <h1 class="text-3xl font-bold tracking-tight mb-2 text-white">Create Account</h1>
              <p class="text-slate-400 mb-8 text-sm">Start building your legacy today.</p>
              ...
              <div class="flex flex-col space-y-4 mb-6">
                  <a href="/google/redirect" 
                     class="group relative w-full flex items-center justify-center px-6 py-3 border border-white/10 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300">
                      ...
                      <span class="font-medium text-slate-200">Sign up with Google</span>
                  </a>
              ...
              <form class="space-y-4" onsubmit={(e) => { e.preventDefault(); submitForm(); }}>
                  <div class="space-y-1.5">
                      <label for="name" class="block text-sm font-medium text-slate-300 ml-1">Full Name</label>
                  ...
                  <div class="grid grid-cols-2 gap-4">
                      <div class="space-y-1.5">
                          <label for="password" class="block text-sm font-medium text-slate-300 ml-1">Password</label>
                          <input bind:value={form.password} required type="password" name="password" id="password" 
                              placeholder="••••••••" 
                              class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:ring-2 focus:ring-info-500/50 focus:border-info-400/50 outline-none transition-all text-white placeholder:text-slate-500" >
                      </div>
                      <div class="space-y-1.5">
                          <label for="confirm-password" class="block text-sm font-medium text-slate-300 ml-1">Confirm</label>
                  ...
                  <p class="text-center text-sm text-slate-400 mt-6">
                      Already have an account? <a href="/login" use:inertia class="font-semibold text-info-400 hover:text-info-300 transition-colors">Sign in</a>
                  </p>
              </form>
          </div>
      </div>
